...
download_launches = BashOperator(task_id='download_launches',
                                 bash_command='curl -o /temp/lanuches.json -L "https://ll.thespacedevs.com/2.0.0/launch/upcoming',
                                 dag=dag)
    ...
    with open('/tmp/launches.json') as f:
        ...
        for image_url in image_urls:
            try:
                ...
                image_filename = image_url('/')[-1]
                target_file = f'/temp/images/{image_filename}'
